...
let GoogleCalendarService = (() => {
    ...
    var GoogleCalendarService = class {
        ...
        addEvent(event) {
            return this.http.post(this.calUrl, event);
        }
        deleteEvent() {
        }
        //taskslists api methods
        getTaskLists() {
            return this.http.get(`${this.taskUrl}/tasklists`);
        }
        getTaskfromLists(listId) {
            return this.http.get(`${this.taskUrl}/tasklists/${listId}/tasks`);
        }
        createTask(listId, task) {
            return this.http.post(`${this.taskUrl}/tasklists/${listId}/tasks`, task);
        }
        completeTask(listId, taskId) {
            return this.http.patch(`${this.taskUrl}/tasklists/${listId}/tasks/${taskId}/complete}`, {});
        }
